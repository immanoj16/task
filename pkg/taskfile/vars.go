...
func (vs *Vars) UnmarshalYAML(node *yaml.Node) error {
	...
	// on this style of custom unmarshelling even numbers
	// contains the keys; while odd numbers contains the
	// values
...
// Set sets a value to a given key of Vars
...
func (vs *Vars) ToCacheMap(m map[string]interface{}) {
	...
	vs.Range(func(key string, value Var) error {
		if value.Sh != "" {
